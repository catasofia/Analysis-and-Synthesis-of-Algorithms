...
diff --side-by-side --suppress-common-lines ou1 outros\ testes/Venancio/OutParaNelson.out;
echo "Testing Major"
#Major
for i in outros\ testes/Major/*;do printf "Test: " ; ./a.out<"$i"; done >out
for i in outros\ testes/Major/*;do printf "Test: " ; tail --lines=1 "$i"; done >outO;
diff --side-by-side --suppress-common-lines out outO;
echo "Testing Oliveira"
#Oliveira
for i in outros\ testes/Oliveira/test/*;do printf "Test: " ;./a.out<"$i"; done >out
for i in outros\ testes/Oliveira/res/*;do printf "Test: " ;cat "$i"; done >outO; 
diff --side-by-side --suppress-common-lines out outO;
